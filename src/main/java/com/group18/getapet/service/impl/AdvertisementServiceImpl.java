...
public class AdvertisementServiceImpl implements AdvertisementService {
    ...
    public AdvertisementServiceImpl(UserRepository userRepository, PetRepository petRepository, AdvertisementRepository advertisementRepository) {
    ...
    @Override
    public Advertisement update(Long id, String title, AdType adType, Pet pet, User user, String location, Integer price) {
